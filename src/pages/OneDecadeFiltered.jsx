    ...
    <div className="for-all-divs">
      ...
      {filteredDecade &&
        filteredDecade.map((song) => (
          <div key={song.id} className="all-songs-info-container">
            <Link to={`/songs/${song.id}`} className="links-songs">
              <div>
...
export default OneDecadeFiltered;